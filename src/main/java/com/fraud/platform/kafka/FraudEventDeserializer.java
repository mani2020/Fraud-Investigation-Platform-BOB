 ...
 * 
 * <p>This deserializer automatically detects the schema version and deserializes
 * the JSON payload to CanonicalFraudEvent, supporting both v1 (flat) and v2 (nested) formats.</p>
 * 
 * <h2>Version Detection:</h2>
 * <ul>
 *   <li><b>v1</b>: Legacy flat structure (no schemaVersion field or schemaVersion="v1")</li>
 ...
 * props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, FraudEventDeserializer.class);
 * 
 * KafkaConsumer<String, CanonicalFraudEvent> consumer = new KafkaConsumer<>(props);
 * }</pre>
 * 
 * <h3>2. Consuming Messages:</h3>
 * <pre>{@code
 * ConsumerRecords<String, CanonicalFraudEvent> records = consumer.poll(Duration.ofMillis(100));
 ...
 *   ...
 * }
 * // Detected as v1, deserialized to CanonicalFraudEvent with schemaVersion="v1"
 * 
 ...
 *   ...
 * }
 * // Detected as v2, deserialized to CanonicalFraudEvent with schemaVersion="v2"
 * }</pre>
 * 
...
public class FraudEventDeserializer implements Deserializer<CanonicalFraudEvent> {
     ...
     * 
     * <p>Deserializes legacy TransactionEvent and transforms it to CanonicalFraudEvent
     * using TransactionEventMapper.</p>
     * 
     ...
     * 
     * <p>Directly deserializes JSON to CanonicalFraudEvent using Jackson.</p>
     * 
     ...
     * 
     * <p>This method is useful for Spring integration where the mapper
     * can be injected after construction.</p>
     * 
